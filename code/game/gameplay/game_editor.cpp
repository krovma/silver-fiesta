...
game_editor::game_editor(app* app)
	:m_app(app)
{
...
void game_editor::update(float32 delta_sec)
{
...
void game_editor::create_test_bullet(bullet_proto& proto)
{
	delete m_test_bullet;
